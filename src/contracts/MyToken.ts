...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u256.fromString('1000000000'); // Your max supply. (Here, 1 billion tokens)
        const decimals: u8 = 10; // Your decimals.
        const name: string = 'ken'; // Your token name.
        const symbol: string = 'Ken'; // Your token symbol.
